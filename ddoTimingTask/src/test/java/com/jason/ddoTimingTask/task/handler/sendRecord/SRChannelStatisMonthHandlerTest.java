...
public class SRChannelStatisMonthHandlerTest extends BaseTaskTest {

	private SRChannelStatisMonthHandler handler;
	protected void setUp() throws Exception {
		super.setUp();
		this.handler = new SRChannelStatisMonthHandler();
	}
