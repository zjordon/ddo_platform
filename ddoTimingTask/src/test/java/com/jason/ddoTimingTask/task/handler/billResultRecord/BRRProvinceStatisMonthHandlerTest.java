...
public class BRRProvinceStatisMonthHandlerTest extends BaseTaskTest {

	private BRRProvinceStatisMonthHandler handler;
	protected void setUp() throws Exception {
		super.setUp();
		this.handler = new BRRProvinceStatisMonthHandler();
	}
