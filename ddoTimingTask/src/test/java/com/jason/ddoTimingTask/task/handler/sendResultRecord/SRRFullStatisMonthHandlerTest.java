...
public class SRRFullStatisMonthHandlerTest extends BaseTaskTest {

	private SRRFullStatisMonthHandler handler;
	protected void setUp() throws Exception {
		super.setUp();
		this.handler = new SRRFullStatisMonthHandler();
	}
	...
	public void testHandle() throws HandlerException {
		...
		sendRecord = this.getSendRecord(sendResultRecord.getDdoMsgId());
		if (sendRecord != null && sendRecord.getState() == 1) {
			if (this.handler.handle(sendRecord, sendResultRecord)) {
				this.handler.commit();
			}
