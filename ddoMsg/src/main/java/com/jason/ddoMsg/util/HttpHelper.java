...
public class HttpHelper {
	...
	public DeliverResponse post(String httpUrl, Map<String, String> paramMap)
		...
		//设置超时时间为1秒
		RequestConfig requestConfig = RequestConfig.custom().setConnectionRequestTimeout(5000).setConnectTimeout(1000).setSocketTimeout(5000).build();
	...
	public DeliverResponse get(String httpUrl, Map<String, String> paramMap)
		...
		//设置超时时间为1秒
		RequestConfig requestConfig = RequestConfig.custom().setConnectionRequestTimeout(5000).setConnectTimeout(5000).setSocketTimeout(1000).build();
