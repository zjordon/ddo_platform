 ...
 *
 */
public class UpdateChannelUserStateEvent extends AbstractEvent {
	private static final Logger logger = Logger
			.getLogger(UpdateChannelUserStateEvent.class);
	...
	public void processEvent(String param)
		...
		try {
			CacheManager.getInstance().getChannelUserCache().updateChannelUserState(id, stateI);
		} catch (ElementNotFoundException e) {
			logger.error("exception when process UpdateUserStateEvent", e);
