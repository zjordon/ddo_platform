...
<body>
    ...
    <div id="login">
        ...
        <div class="inner">
            ...
            <div class="logo">ddo渠道用户管理平台</div>
            <div class="formLogin">
                <form name="formLogin" id="formLogin" action="frontChannelUserController.do?doLogin" check="frontChannelUserController.do?checkuser" method="post">
                    <input name="userKey" type="hidden" id="userKey" value="D1B5CC2FE46C4CC983C073BCA897935608D926CD32992B5900" />
                    <div class="tip">
                        <input class="userName" name="username" type="text" id="username" title="" iscookie="true" value="test" nullmsg="" />
                    </div>
                    <div class="tip">
                        <input class="password" name="password" type="password" id="password" title="" value="test123" nullmsg="" />
                    </div>
                    <%--update-begin--Author:zhangguoming  Date:20140226 for：添加验证码--%>
                    <div>
                        <div style="float: right; margin-left:-150px; margin-right: 40px;">
    ...
    <script type="text/javascript" src="plug-in/login/js/channel-login.js"></script>
