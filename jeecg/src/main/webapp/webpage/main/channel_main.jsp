...
<!-- 顶部-->
<div region="north" border="false" title="ddo渠道管理平台" style="BACKGROUND: #E6E6FA; height: 85px; padding: 1px; overflow: hidden;">
        ...
        <table>
            <tr>
                <td valign="top" height="50">
                    ...
                    <span style="color: #CC33FF"><t:mutiLang langKey="current.channel"/>:</span>
                    <span style="color: #666633">${channelName }</span>
                </td>
            </tr>
            <tr>
               ...
               <%--
                ...
                <div id="layout_north_zxMenu" style="width: 100px; display: none;">
                    <div class="menu-sep"></div>
                    <div onclick="exit('frontChannelUserController.do?logout','<t:mutiLang langKey="common.exit.confirm"/>',1);"><t:mutiLang langKey="common.exit"/></div>
                </div>
            </tr>
        </table>
    </td>
...
<!-- 左侧-->
<div region="west" split="true" href="frontChannelUserController.do?left" title="<t:mutiLang langKey="common.navegation"/>" style="width: 200px; padding: 1px;"></div>
<!-- 中间-->
<div id="mainPanle" region="center" style="overflow: hidden;">
    <div id="maintabs" class="easyui-tabs" fit="true" border="false">
    <div class="easyui-tab" title="<t:mutiLang langKey="common.dash_board"/>" href="frontChannelUserController.do?home" style="padding: 2px; overflow: hidden;"></div>
