...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" layout="table" action="smTaskController.do?save" beforeSubmit="check" callback="@Override uploadFile">
  	<input type="hidden" id="taskId" name="taskId" value=""/>
            ...
            <div class="form" id="filediv"></div>
				...
				<tr>
					...
					<td class="value">
					    <t:comboBox url="channelController.do?combox" name="channelId" text="name" id="id" multiple="false"></t:comboBox>
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
					    <t:comboBox url="billBusinessController.do?combox" name="billBusinessId" text="price" id="id" multiple="false"></t:comboBox>
						<span class="Validform_checktip"></span>
					</td>
				</tr>
			</table>
