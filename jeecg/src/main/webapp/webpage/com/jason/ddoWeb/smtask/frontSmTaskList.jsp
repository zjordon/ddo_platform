...
<div id="main_task_list" class="easyui-layout" fit="true">
  ...
  <t:datagrid name="smTaskList" title="短信任务" actionUrl="frontSmTaskController.do?datagrid" idField="id" fit="true">
   ...
   <t:dgToolBar title="手工输入号码" icon="icon-add" url="frontSmTaskController.do?addorupdate" funname="add"></t:dgToolBar>
   <t:dgToolBar title="批量导入号码" icon="icon-add" url="frontSmTaskController.do?upload" funname="add"></t:dgToolBar>
...
<script type="text/javascript">
    ...
    function queryMsisdnList(taskId){
        ...
        $('#userListpanel').panel("refresh", "frontSmMsisdnListController.do?smMsisdnList&taskId=" + taskId);
    }
