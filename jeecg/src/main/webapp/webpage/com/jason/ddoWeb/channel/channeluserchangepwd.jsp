...
<t:formvalid formid="formobj" refresh="false" dialog="true" action="channelUserController.do?savenewpwdforuser" usePlugin="password" layout="table">
	<input id="id" type="hidden" name="id" value="${channelUserPage.id}">
