  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" beforeSubmit="check" action="smTaskController.do?save">
			...
			<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					    <t:comboBox url="channelController.do?combox" name="channelId" text="name" id="id" multiple="false" selectedValue="${smTaskPage.channelId}"></t:comboBox>
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
					    <t:comboBox url="billBusinessController.do?combox" name="billBusinessId" text="price" id="id" multiple="false" selectedValue="${smTaskPage.billBusinessId}"></t:comboBox>
						<span class="Validform_checktip"></span>
					</td>
				</tr>
			</table>
