 ...
 * @Description: 全量统计
 * @author zhangdaihao
 * @date 2015-04-23 15:11:46
 * @version V1.0   
 *
 */
@Entity
@Table(name = "ddo_full_statistics_day", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
@ExcelTarget("fullStatisticsDayEntity")
public class FullStatisticsDayEntity implements java.io.Serializable {
	/**唯一标识*/
